...
B7_e2b_pl<- load.bigWig(paste(path, "B7_TAM_plus.bw", sep=""))
B7_e2b_mn<- load.bigWig(paste(path, "B7_TAM_minus.bw", sep=""))
...
G11_e2b_pl<- load.bigWig(paste(path, "G11_TAM_plus.bw", sep=""))
G11_e2b_mn<- load.bigWig(paste(path, "G11_TAM_minus.bw", sep=""))
...
pdf("E2_TAM_trt.pdf")
doit(erbs, stp=20, halfWindow=2000, B7_c_pl, B7_c_mn, B7_e2_pl, B7_e2_mn, B7_e2b_pl, B7_e2b_mn, main="B7 E2-TAM stimulation")
doit(erbs, stp=20, halfWindow=2000, G11_c_pl, G11_c_mn, G11_e2_pl, G11_e2_mn, G11_e2b_pl, G11_e2b_mn, main="G11 E2-TAM stimulation")
dev.off()
